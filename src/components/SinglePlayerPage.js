...
/*
  SinglePlayerPage - Dedicated page for single player mode
  Contains the game logic, history, leaderboard, and helper panel
*/

export default function SinglePlayerPage({ playerName, difficultyKey, onBackToHome }) {
